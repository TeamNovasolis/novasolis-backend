...
public class JwtTokenService {
    ...
    private final NovasolisConfigProperties novasolisConfigProperties;
    ...
    private Claims getAllClaimsFromToken(String token) {
        return Jwts.parser().setSigningKey(novasolisConfigProperties.jwtSecret()).parseClaimsJws(token).getBody();
    }
    ...
    public String generateToken(UserEntity user) {
        ...
        return doGenerateToken(claims, String.format("%s,%s", user.getId(), user.getEmail()));
    }
